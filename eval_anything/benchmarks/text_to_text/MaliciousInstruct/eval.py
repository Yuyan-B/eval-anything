...
class MaliciousInstruct(T2TBenchmark):
    ...
    def to_InferenceInput(self, task_list: list[str]) -> dict[str, list[InferenceInput]]:
        ...
        with open("/share/project/buyuyan/eval-anything-local/data/MaliciousInstruct.txt") as f:
    ...
    def to_EvaluationResult(
        ...
        self.display_benchmark_results(self.benchmark_name, {"MaliciousInstruct": {"Attack Success Rate": {"default": harmfulness_rate}}})
