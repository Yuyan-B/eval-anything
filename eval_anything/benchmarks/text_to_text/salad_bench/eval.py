...
from eval_anything.benchmarks.text_to_text.salad_bench.utils import (
    merge_categories,
)
...
class salad_bench(T2TBenchmark):
    ...
    def to_InferenceOutput(
        ...
        for output_item, eval_label, eval_clse in zip(inference_outputs['salad_bench'], eval_labels, eval_clses):
            try:
